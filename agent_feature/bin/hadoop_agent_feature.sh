...
INPUT_PATH="${LEGAL_DELEGATION}"
OUTPUT_PATH="${AGENT_FEATURE}/${begain_date}_${end_date}"
...
${HADOOP_HOME}/bin/hadoop fs -getmerge "${OUTPUT_PATH}/part*" "${INNER_DATA_PATH}/${AGENT_FEATURE_MERGE_FILENAME}"
if [ $? == 0 ] 
then
...
${HADOOP_HOME}/bin/hadoop fs -rm -r ${AGENT_FEATURE_MERGE_PATH}/${AGENT_FEATURE_MERGE_FILENAME}
${HADOOP_HOME}/bin/hadoop fs -put ${INNER_DATA_PATH}/${AGENT_FEATURE_MERGE_FILENAME} ${AGENT_FEATURE_MERGE_PATH}
