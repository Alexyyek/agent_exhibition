...
${HADOOP_HOME}/bin/hadoop fs -getmerge "${OUTPUT_PATH}/part*" "${INNER_DATA_PATH}/${AGENT_RESBLOCK_TOP_MERGE_FILENAME}"
if [ $? == 0 ] 
then
...
${HADOOP_HOME}/bin/hadoop fs -rm -r ${AGENT_RESBLOCK_TOP_MERGE_PATH}/${AGENT_RESBLOCK_TOP_MERGE_FILENAME}
${HADOOP_HOME}/bin/hadoop fs -put ${INNER_DATA_PATH}/${AGENT_RESBLOCK_TOP_MERGE_FILENAME} ${AGENT_RESBLOCK_TOP_MERGE_PATH}
