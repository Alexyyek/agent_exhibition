...
class CommonFealib(object):
    def __init__(self):
        ...
        for i in range(len(self.feature_order)):
            if i == 0:
                self.feature_transform[self.feature_order[i]] = 1
            else:
    ...
    def printNoMergeFeatureDes(self):
        """
            ...
            if global_field[1] == 1:
                ...
                for local_field in self.feature_order:
                    ...
                    for i in range(len(feature_dict)):
                        ...
                        print "{encode}\t{global_field}{local_field}[{real_desc}]\tq".format(
    ...
    def updateFea(self, input_str, method, output_dict, fea_type="continue"):
        """
            input_str: discret  input data
        ...
        if fea_type == "continue":
            ...
            raise CommonFealibErr("input method:%s, not continue or discret" % fea_type)

    
if __name__=='__main__':
    test = CommonFealib()
    test.printMergeFeatureDes()
